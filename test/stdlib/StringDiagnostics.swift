...
func testIntSubscripting(s: String, i: Int) {
  ...
  _ = s[i...i] // expected-error{{subscript' is unavailable: cannot subscript String with a ClosedRange<Int>, see the documentation comment for discussion}}
  ...
  _ = s[17...20] // expected-error{{subscript' is unavailable: cannot subscript String with a ClosedRange<Int>, see the documentation comment for discussion}}
