...
struct BridgedLocation {
  ...
  SWIFT_IMPORT_UNSAFE BRIDGED_INLINE BridgedLocation getPrologueLocation() const;
...
struct BridgedBuilder{
  ...
  SWIFT_IMPORT_UNSAFE BRIDGED_INLINE BridgedInstruction createEndFormalScope(BridgedValue instance) const;
...
struct BridgedCloner {
  ...
  BridgedCloner(BridgedInstruction inst, BridgedLocation loc, BridgedContext context);
